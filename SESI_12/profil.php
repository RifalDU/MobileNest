...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif ($action === 'ubah_password') {
        ...
        if ($password_baru !== $password_konfirm) {
            $errors[] = 'Password baru tidak sama dengan konfirmasi';
        }
...
<body>
    ...
    <div class="container py-5">
        ...
        <ul class="nav nav-pills mb-4 border-bottom">
            <li class="nav-item">
                <a class="nav-link active" href="#data-pribadi" data-bs-toggle="tab">
                    📋 Data Pribadi
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#ubah-password" data-bs-toggle="tab">
                    🔐 Ubah Password
                </a>
            </li>
        </ul>
                ...
                <form method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Email untuk login dan komunikasi</small>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Nomor telepon untuk pengiriman</small>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Alamat lengkap untuk pengiriman</small>
                        </div>
                    </div>
