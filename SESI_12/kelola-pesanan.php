...
/**
 * ============================================
 * FILE: kelola-pesanan.php
 * PURPOSE: Admin Manage Orders
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_status') {
    ...
    // Jika status Dikirim, no_resi harus ada
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="btn-group" role="group">
                    <a href="kelola-pesanan.php?status=semua" class="btn btn-outline-primary <?php echo $filter_status === 'semua' ? 'active' : ''; ?>">
                        Semua
                    </a>
                    <a href="kelola-pesanan.php?status=Pending" class="btn btn-outline-warning <?php echo $filter_status === 'Pending' ? 'active' : ''; ?>">
                        Pending
                    </a>
                    <a href="kelola-pesanan.php?status=Diproses" class="btn btn-outline-info <?php echo $filter_status === 'Diproses' ? 'active' : ''; ?>">
                        Diproses
                    </a>
                    <a href="kelola-pesanan.php?status=Dikirim" class="btn btn-outline-primary <?php echo $filter_status === 'Dikirim' ? 'active' : ''; ?>">
                        Dikirim
                    </a>
                    <a href="kelola-pesanan.php?status=Selesai" class="btn btn-outline-success <?php echo $filter_status === 'Selesai' ? 'active' : ''; ?>">
                        Selesai
                    </a>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive">
                        <table class="table table-hover table-pesanan">
                                ...
                                <?php if (!empty($transaksi)): ?>
                                    <?php foreach ($transaksi as $item): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="status-badge status-<?php echo strtolower($item['status_pesanan']); ?>">
                                                    <?php echo ucfirst($item['status_pesanan']); ?>
                                                </span>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-info" data-bs-toggle="modal" 
                                                        data-bs-target="#detailModal"
                                                        onclick="showDetail(<?php echo htmlspecialchars(json_encode($item)); ?>)">
                                                    Detail
                                                </button>
                                            </td>
                                        </tr>
    ...
    <script>
        function showDetail(pesanan) {
            ...
            const html = `
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <strong>User:</strong><br> ${pesanan.nama_lengkap}
                    </div>
                </div>
                
                <div class="row mb-3">
                    <div class="col-6">
                        <strong>No. Telepon:</strong><br> ${pesanan.no_telepon}
                    </div>
                    <div class="col-6">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <strong>Alamat Pengiriman:</strong><br> ${pesanan.alamat}
                    </div>
                </div>
                
                <div class="row mb-3">
                    <div class="col-6">
                        <strong>Jumlah Item:</strong><br> ${pesanan.jumlah_item}
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <span class="status-badge status-${pesanan.status_pesanan.toLowerCase()}">
