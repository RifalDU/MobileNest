...
// Process BATAL PESANAN (hanya untuk status Pending)
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center">
                        📭 Anda belum memiliki pesanan. <a href="../list-produk.php">Mulai belanja sekarang!</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
    ...
    <script>
        function showDetail(pesanan) {
            const html = `
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <strong>Status:</strong><br> <span class="status-badge status-${pesanan.status_pesanan.toLowerCase()}">${pesanan.status_pesanan}</span>
                    </div>
                    <div class="col-6">
